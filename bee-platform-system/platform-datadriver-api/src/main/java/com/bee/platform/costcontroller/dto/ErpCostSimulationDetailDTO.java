...
import com.bee.platform.costcontroller.rq.ErpCostIndexInputRQ;
import com.bee.platform.costcontroller.rq.ErpCostSimulationComputedResultRQ;
...
@ApiModel(value = "erpc成本模拟详情的DTO")
public class ErpCostSimulationDetailDTO implements Serializable {
