...
import com.bee.platform.dinas.datadriver.config.properties.WebServerConfigProperties;

import lombok.extern.slf4j.Slf4j;

/**
 * @author zhigang.zhou
 *  springboot内嵌Tomcat的长连接参数的优化: 当Spring容器内没有TomcatEmbeddedServletContainerFactory这个bean时，会把此bean加载进spring容器中。
 */
@Slf4j
@Component
