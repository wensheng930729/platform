 ...
 * @Description 访问接口平台的地址http://localhost:8900/platform-dinasdatadriver/swagger-ui.html
 * @author zhigang.zhou
...
//        pars.add(ticketPar2.build());
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("金蜜平台进销存-砂石项目restful api")
                .description("platform-dinasdatadriver api接口文档")
                //服务条款网址
