...
public class CommonServiceImpl implements CommonService {
     ...
     */
    @Override
    public List<ErpRepositoryListDTO> getRepositoryListByCompanyId(Integer companyId) {
        ...
        List<ErpRepositoryListDTO> dto = BeanUtils.assemble(ErpRepositoryListDTO.class, list);
    ...
    public List<ErpProductBoxDTO> getProductListByCompanyId(Integer companyId) {
        ...
        List<ErpProductBoxDTO> dto = BeanUtils.assemble(ErpProductBoxDTO.class, list);
    ...
    public List<ErpTestReportSearchListDTO> searchTestReportList(String testCode) {
        ...
        List<ErpTestReportSearchListDTO> dto = BeanUtils.assemble(ErpTestReportSearchListDTO.class, list);
    ...
    public List<ErpFurnaceBoxDTO> getFurnaceListByCompanyId(Integer companyId) {
        ...
        List<ErpFurnaceBoxDTO> dto = BeanUtils.assemble(ErpFurnaceBoxDTO.class, list);
    ...
    public List<ErpPurchaseListDTO> getPurchaseListByUserInfo(String sysToken) {
        ...
        if (org.springframework.util.CollectionUtils.isEmpty(enterpriseFlatDTOS)) {
            log.error("未查询到当前用户企业信息！ 类：{} 方法：{}", "CommonServiceImpl", "getPurchaseListByUserInfo");
        ...
        List<ErpPurchaseListDTO> dto = BeanUtils.assemble(ErpPurchaseListDTO.class, list);
    ...
    public List<ErpPurchaseListDTO> getPurchaseListByUserCompanyId(Integer orgId) {
        List<ErpPurchaseOrder> list = erpPurchaseOrderService.selectList(new EntityWrapper<ErpPurchaseOrder>().eq("deleted", 0).eq("company", orgId));
    ...
    public List<ErpSaleListDTO> getSaleListByUserCompanyId(Integer orgId) {
        ...
        List<ErpSaleOrder> list = erpSaleOrderService.selectList(new EntityWrapper<ErpSaleOrder>().eq("deleted", 0).eq("company", orgId));

        List<ErpSaleListDTO> dto = BeanUtils.assemble(ErpSaleListDTO.class, list);
     ...
     */
    @Override
    public List<ErpProductBoxDTO> getProductListByPurchaseId(Integer purchaseId) {

        List<ErpProductBoxDTO> dto = commonMapper.getProductListByPurchaseId(purchaseId);
     ...
     */
    @Override
    public List<ErpProductBoxDTO> getProductListBySaleId(Integer saleId) {

        List<ErpProductBoxDTO> dto = commonMapper.getProductListBySaleId(saleId);
    ...
    public int getRedisCode(String redisKey) {
        ...
        if (StringUtils.isEmpty(valueString)) {
            ...
            valueCode = Integer.valueOf(valueString);
        }
        return valueCode;
    }
}
