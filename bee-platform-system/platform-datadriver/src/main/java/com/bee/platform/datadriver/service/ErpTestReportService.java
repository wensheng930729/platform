...
public interface ErpTestReportService extends IService<ErpTestReport> {
     ...
     * @return
     */
    List<ErpTestReportDTO> listTestReport(Pagination pagination, TestReportQueryRQ rq, Integer companyId);
     ...
     * @return
     */
    ResponseResult<ErpTestReport> getTestReportByWarehousingOrder(ErpGetOneTestReportRQ rq);
}
