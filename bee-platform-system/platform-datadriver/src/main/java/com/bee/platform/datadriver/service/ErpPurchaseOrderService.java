...
public interface ErpPurchaseOrderService extends IService<ErpPurchaseOrder> {
     ...
     * @return
     */
    List<ErpPurchaseOrderInfoDTO> listErpPurchaseOrder(Pagination pagination, OrderQueryRQ rq, Integer companyId);
     ...
     * @return
     */
    ResponseResult<ErpPurchaseOrderDTO> getErpPurchaseOrder(AuthPlatformUserInfo userInfo, String id);
     ...
     * @return
     */
    ResponseResult<ErpPurchaseOrderInfoDetailDTO> getErpPurchaseOrderById(AuthPlatformUserInfo userInfo, Integer id);
     ...
     * @return
     */
    ResponseResult<List<ErpPucharseOrderBoxDTO>> getPucharseOrderBox(AuthPlatformUserInfo userInfo,String sysToken);
     ...
     * @return
     */
    ResponseResult<Integer> deleteErpPurchaseOrder(AuthPlatformUserInfo userInfo, OrderDeleteRQ rq);
