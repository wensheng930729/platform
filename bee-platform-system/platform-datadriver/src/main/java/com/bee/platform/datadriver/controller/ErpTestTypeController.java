...
public class ErpTestTypeController {
    ...
    public ResponseResult<List<ErpTestType>> listErpTestType(HttpServletRequest request, @RequestBody TestReportTypeRQ rq,Page page){
        ...
        /*if (Objects.isNull(companyId)){
            log.info("为获取到公司id");
            return ResponseResult.buildResponseResult(ResCodeEnum.ERROR_PARAMETER, null);
        }*/
        Pagination pagination = PageUtils.transFromPage(page);
        List<ErpTestType> list = testTypeService.listErpTestType(sysToken, companyId,rq,pagination);
    ...
    //@Log(businessType= EnumBusinessType.TEST_TYPE, operateType = OperateType.DELETE)
    ...
    //@Log(businessType= EnumBusinessType.TEST_TYPE, operateType = OperateType.ADD)
    ...
    public ResponseResult<List<ErpTestType>> getTestType(HttpServletRequest request){
		...
		return testTypeService.getTestType(userInfo.getId(),sysToken);
    }
}
