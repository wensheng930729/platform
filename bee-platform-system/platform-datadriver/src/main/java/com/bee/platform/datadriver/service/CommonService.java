...
public interface CommonService {
    ...
    List<ErpRepositoryListDTO> getRepositoryListByCompanyId(Integer companyId);
    ...
    List<ErpProductBoxDTO> getProductListByPurchaseId(Integer purchaseId);

    List<ErpProductBoxDTO> getProductListBySaleId(Integer saleId);
