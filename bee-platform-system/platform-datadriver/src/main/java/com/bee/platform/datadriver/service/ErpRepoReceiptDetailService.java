...
public interface ErpRepoReceiptDetailService extends IService<ErpRepoReceiptDetail> {
    ...
    ResponseResult<Integer> addPurchaseGoodsOrderDetail(AuthPlatformUserInfo simpleUserInfo, RepoReceiptDetailRQ repoReceiptDetailRQ);

    ResponseResult<Integer> updatePurchaseGoodsOrderDetail(RepoReceiptDetailRQ repoReceiptDetailRQ);

    ResponseResult<ResCodeEnum> deletePurchaseGoodsOrderDetail(Integer id);

    ResponseResult<List<RepoReceiptDetailDTO>> findReoReceiptDetailInfo(Integer id);
