...
@ApiModel("采购订单修改请求信息")
public class DinasPurchaseOrderUpdateRQ implements Serializable {

    private static final long serialVersionUID = 8207329779139128090L;
    ...
    @Valid
    private List<DinasPurchaseAdjustRQ> adjustDtos;
