...
@RestController
@CrossOrigin(origins = "*")
@Api(value = "authUsergroupBack", tags = "新权限：用户组相关接口-后台")
@RequestMapping("/authUsergroupBack")
public class AuthUsergroupBackController {

    @Autowired
    private AuthUsergroupBackService usergroupService;
    @Autowired
