...
@RestController
@CrossOrigin(origins = "*")
@Api(value = "authUsergroupUser", tags = "新权限：用户组和用户关联关系相关接口")
@RequestMapping("/authUsergroupUser")
public class AuthUsergroupUserController {

    @Autowired
    private AuthUsergroupUserService authUsergroupUserService;
