...
@ApiModel("编辑物流订单跟踪需要的参数")
public class ErpUpdateLogisticsTrackingRQ implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -4597414953000951942L;
