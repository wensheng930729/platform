...
public enum EnumBusinessType {
     ...
     * 仓库档案
     */
    STOREHOUSE_PROFILE("storehouse_profile", "仓库档案"),
    
    /**
     * 物流订单添加和编辑
     */
    LOGISTICS_ORDERS("LOGISTICS_ORDERS", "物流订单"),
    
    /**
     * 物流订单状态
     */
    LOGISTICS_ORDERS_STATUS("LOGISTICS_ORDERS_STATUS", "物流订单状态"),
    
    
    /**
     * 物流结算
     */
    LOGISTICS_SETTLEMENT("LOGISTICS_SETTLEMENT", "物流结算添加"),
    
    /**
     * 物流跟踪
     */
    LOGISTICS_TAIL_AFTER("LOGISTICS_TAIL_AFTER", "物流跟踪"),
    
    /**
     * 物流订单发票
     */
    LOGISTICS_INVOICE("LOGISTICS_INVOICE", "物流订单发票"),
    
    /**
     * 物流付款
     */
    LOGISTICS_PAYMENT("LOGISTICS_PAYMENT", "物流付款"),
    ;
