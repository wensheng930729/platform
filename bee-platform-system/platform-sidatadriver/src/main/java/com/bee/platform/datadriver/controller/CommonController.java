...
public class CommonController {
    ...
    public ResponseResult<List<ErpRepositoryBoxDTO>> getRepositoryListByCompanyId(@RequestParam Integer companyId) {

        if (ObjectUtils.isEmpty(companyId)) {
            log.info("参数异常");
            return ResponseResult.buildResponseResult(ResCodeEnum.ERROR_PARAMETER);
        }
        List<ErpRepositoryBoxDTO> dto = commonService.getRepositoryListByCompanyId(companyId);
    ...
    public ResponseResult<List<ErpProductAndBatchListDTO>> getProductListByPurchaseId(@RequestParam Integer purchaseId) {
        if (ObjectUtils.isEmpty(purchaseId)) {
            log.info("参数异常");
            return ResponseResult.buildResponseResult(ResCodeEnum.ERROR_PARAMETER);
        }
        List<ErpProductAndBatchListDTO> dto = commonService.getProductListByPurchaseId(purchaseId);
    ...
    public ResponseResult<List<ErpProductAndBatchListDTO>> getProductListBySaleId(@RequestParam Integer saleId) {
        if (ObjectUtils.isEmpty(saleId)) {
            log.info("参数异常");
            return ResponseResult.buildResponseResult(ResCodeEnum.ERROR_PARAMETER);
        }
        List<ErpProductAndBatchListDTO> dto = commonService.getProductListBySaleId(saleId);
