...
public interface ErpTestTypeService extends IService<ErpTestType> {
     ...
     * @return
     */
    List<ErpTestTypeDTO> listErpTestType(AuthPlatformUserInfo userInfo, TestReportTypeRQ rq, Pagination pagination);
	 ...
	 * @return
	 */
	ResponseResult<List<ErpTestType>> getTestType(Integer orgId);
}
