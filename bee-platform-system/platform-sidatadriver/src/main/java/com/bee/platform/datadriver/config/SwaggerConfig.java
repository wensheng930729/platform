 ...
 * @Description 访问接口平台的地址http://localhost:8800/platform-sidatadriver/swagger-ui.html
 * @author zhigang.zhou
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("金蜜平台进销存系统-硅系项目restful api")
                .description("platform-sidatadriver api接口文档")
                //服务条款网址
