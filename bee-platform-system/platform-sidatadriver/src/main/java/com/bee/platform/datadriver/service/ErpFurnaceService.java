...
public interface ErpFurnaceService extends IService<ErpFurnace> {
     ...
     * @return
     */
    ResponseResult<List<ErpFurnaceListDTO>> query(Integer companyId, Integer status, Pagination pagination);
    /**
     * 查询当前用户企业下的炉号
     * @param orgId
     * @return
     */
    ResponseResult<List<ErpFurnaceBoxDTO>> queryFurnaceNum(Integer orgId);
