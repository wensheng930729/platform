...
//        detailDTO.setCheckItems(JSON.parseArray(productCategory.getCheckItems(), ErpProductCheckItemsDTO.class));
//        return ResponseResult.buildResponseResult(ResCodeEnum.SUCCESS, detailDTO);
//    }

    @Override
    public ResponseResult<List<ErpProductCategoryDTO>> getCategory() {
...
//            return ResponseResult.buildResponseResult(ResCodeEnum.PRODUCT_CATEGORY_NOT_EXIST);
//        }
//        List<ErpProductCheckItemsDTO> checkItems = JSON.parseArray(productCategory.getCheckItems(), ErpProductCheckItemsDTO.class);
