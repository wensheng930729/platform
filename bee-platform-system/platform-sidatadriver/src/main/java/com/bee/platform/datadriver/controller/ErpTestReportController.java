...
public class ErpTestReportController {
    ...
    public ResponseResult<List<ErpTestReportDTO>> listTestReport(HttpServletRequest request, @RequestBody TestReportQueryRQ rq , Page page){
        ...
        List<ErpTestReportDTO> list = testReportService.listTestReport(pagination,rq,userInfo);
