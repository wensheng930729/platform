...
export const versionCheck = () => {
  ...
  if (localStorage.hashVersion + '' !== hashVersion + '') {
    ...
    // clearAllCookie()
    const v =
      localStorage.hashVersion > hashVersion
        ? localStorage.hashVersion
        : hashVersion
...
//打开聊天窗口
export const openModal = isShow => {
  window.g_app._store.dispatch({
    type: 'global/reSetVisible',
    payload: Boolean(!isShow)
  })
}
